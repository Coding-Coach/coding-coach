...
module.exports = {
  ...
  */
  ...
  modules: {
    ...
    backgroundColors: ['responsive', 'hover', 'focus', 'focus-within', 'group-hover'],
    ...
    float: ['responsive'],
    fonts: ['responsive'],
    fontWeights: ['responsive', 'hover', 'focus', 'focus-within'],
    height: ['responsive'],
    leading: ['responsive'],
    lists: ['responsive'],
    margin: ['responsive'],
    ...
    textStyle: ['responsive', 'hover', 'focus', 'focus-within', 'group-hover'],
    tracking: ['responsive'],
