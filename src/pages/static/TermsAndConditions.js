...
function TermsAndConditions() {
  return (
    <div>
      ...
      <small>
        Last updated: <time>October 03, 2018</time>
      </small>
      <p>
        These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with
        www.codingcoach.io website (the "Service") operated by Coding Coach ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        controlled by Coding Coach.
      </p>
      <p>
        Coding Coach has no control over, and assumes no responsibility for, the content, privacy
      ...
      <p>
        ...
        agreements we might have between us regarding the Service. Changes
      </p>
      <p>
        We reserve the right, at our sole discretion, to modify or replace these Terms at any time.
        If a revision is material we will try to provide at least 15 days notice prior to any new
